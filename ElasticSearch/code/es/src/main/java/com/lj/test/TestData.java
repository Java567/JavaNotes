...
public class TestData {
    ...
    public void addTestData() throws IOException {
        ...
        smsLogs.setFee(3);
        request.add(new IndexRequest(index, type, "1").source(mapper.writeValueAsString(smsLogs), XContentType.JSON));
        ...
        request.add(new IndexRequest(index, type, "2").source(mapper.writeValueAsString(smsLogs), XContentType.JSON));
        ...
        smsLogs1.setFee(5);
        request.add(new IndexRequest(index, type, "3").source(mapper.writeValueAsString(smsLogs1), XContentType.JSON));
        ...
        request.add(new IndexRequest(index, type, "4").source(mapper.writeValueAsString(smsLogs1), XContentType.JSON));
        ...
        smsLogs2.setFee(7);
        request.add(new IndexRequest(index, type, "5").source(mapper.writeValueAsString(smsLogs2), XContentType.JSON));

        smsLogs2.setMobile("18000000001");
        smsLogs2.setProvince("武汉");
        smsLogs2.setSmsContent("【滴滴单车平台】专属限时福利！青桔/小蓝月卡立享5折，特惠畅骑30天。" + "戳 https://xxxxxx退订TD");
        request.add(new IndexRequest(index, type, "6").source(mapper.writeValueAsString(smsLogs2), XContentType.JSON));
        ...
        smsLogs3.setFee(8);
        request.add(new IndexRequest(index, type, "7").source(mapper.writeValueAsString(smsLogs3), XContentType.JSON));

        smsLogs3.setMobile("13990000001");
        smsLogs3.setProvince("武汉");
        smsLogs3.setSmsContent("【招商银行】尊贵的李四先生,恭喜您获得华为P30 Pro抽奖资格,还可领100 元打" + "车红包,仅限1天");
        request.add(new IndexRequest(index, type, "8").source(mapper.writeValueAsString(smsLogs3), XContentType.JSON));
        ...
        smsLogs4.setFee(5);
        request.add(new IndexRequest(index, type, "9").source(mapper.writeValueAsString(smsLogs4), XContentType.JSON));

        smsLogs4.setMobile("13990000002");
        smsLogs4.setProvince("武汉");
        smsLogs4.setSmsContent("【招商银行】尊贵的王五先生,恭喜您获得iphone 56抽奖资格,还可领5 元打" + "车红包,仅限100天");
        request.add(new IndexRequest(index, type, "10").source(mapper.writeValueAsString(smsLogs4), XContentType.JSON));
        ...
        smsLogs5.setFee(4);
        request.add(new IndexRequest(index, type, "11").source(mapper.writeValueAsString(smsLogs5), XContentType.JSON));
        ...
        request.add(new IndexRequest(index, type, "12").source(mapper.writeValueAsString(smsLogs5), XContentType.JSON));
        // -------------------------------------------------------------------------------------------------------------------
